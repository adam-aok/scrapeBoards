...
if (typeof Array.prototype.indexOf != "function") {  
   ...
   for(myCounter = 35; myCounter < app.activeDocument.pages.length; myCounter++){
        //get current page
        ...
        for (w=0;w<myLinks.length;w++) if (myLinks[w].parent.parentPage !== null && myLinks[w].parent.parentPage.name == myCounter + 1 && myLinks[w].name.indexOf("_mr") == -1 && myLinks[w].name.indexOf("_1_1") == -1 && myLinks[w].status !== LinkStatus.LINK_MISSING) linkBucket.push(myLinks[w]);
...
function exportLinks(dT,dN,getLinks){
   for (l = 0; l < getLinks.length; l++){
        ...
        eachLink = getLinks[l];
        savePath = "G:/Committees/Design-Communication/Design On The Boards/2020/Exported/"+dT+"_"+dN;
